...
export default function Interact() {
  ...
  const erc20_evm_address = '0xabde1007e0f5f3166a2d5564a4227d33fade971d'
  ...
  const call = async (walletType: string, func: string, param1, param2) => {
    ...
    const contractAddress = '0x0586add203bac8d5effc4d7cb9d3eb579ce2930961454cd7b7e8480224c40f33'
        ...
        <div className="flex gap-2 mt-2">
          <button
            onClick={async () => {
              ...
              console.log('calldata:', calldata)
              await call('local', 'execute_at_address', '0xabde1007e0f5f3166a2d5564a4227d33fade971d', hex2bytes(calldata))
            }}
            className={utilStyles.buttonPress}
          >
            Approve
            ...
            <button
              onClick={async () => {
                ...
                await call(
                  ...
                  '0x01a0a54f124052e6f21aed50c4b93a80e5f168ab913fcf2657ed142a929e049d',
                  null
                )
              }}
            ...
            <button
              onClick={async () => {
                const result = await call(
                  'local',
                  'initiate',
                  '0xabde1007e0f5f3166a2d5564a4227d33fade971d',
                  '0x755e130c95181fdb38d62868a17e6b5e0f5f3166a2d5564a4227d33fade971d'
                )
              }}
              className="mt-5 bg-green-700 p-3 rounded-md text-gray-100"
            >
